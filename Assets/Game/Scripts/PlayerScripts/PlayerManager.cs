...
public class PlayerManager : NetworkBehaviour
{
    ...
    {
        RaycastHit hit;
        if (isArmed && Physics.BoxCast(myCamera.transform.position, (Vector3.one),myCamera.transform.forward * 1000, out hit, Quaternion.identity, Mathf.Infinity, layermask))

...
public class PlayerManager : Photon.MonoBehaviour, IPunObservable
{
	...
	public void Local__CancelAbility()
	{
	...
	public void Local__DeathState(bool isPlayerDead)
	{
		isDead = isPlayerDead;

...
public class GenericUtilities
{
    ...
    public static int checkIncrement<T>(int value, T[] array)
    {
        value++;
    ...
    public static int checkIncrement<T>(int value, List<T> array)
    {
        value++;
    ...
    public static bool uniqInsert<T>(T checkValue, List<T> valueList)
    {
    ...
    //============The Following Code is by Berenger===============
